  ...
  Class.prototype.init = function(){
    ...
    */
    $.each(options.content,function(index,item){
      spans +='<li><em>'+item+'</em><button type="button" class="close">×</button></li>';
    });
    
    options.elem.before('<ul id="tags-list" class="layui-clear">'+spans+'</ul>');
...
}).link('../static/layui_multi/css/inputTags.css');