...
class GoodsType extends Mall
{
    ...
    public function add()
    {
        ...
        if (Request::isPost()) {
            ...
            $typeData = array_merge($typeData,$userWhere);
            ...
            foreach($type_name as $key=>$val){
                ...
                //将权限值插入
                $typeSpecData[$key]['mall_id'] = isset($userWhere[self::PERMISSION_MALL]) ? $userWhere[self::PERMISSION_MALL] : 0;
                $typeSpecData[$key]['site_id'] = isset($userWhere[self::PERMISSION_SITE]) ? $userWhere[self::PERMISSION_SITE] : 0;
    ...
    public function addRel()
    {
        ...
        if (!Request::isPost()) {
            ...
            $specList      = $typeSpecModel->getAllSpec($userWhere);
    ...
    public function addParams()
    {
        ...
        if (!Request::isPost()) {
            ...
            $goodsParamsModel = new GoodsParams();
            $params           = $goodsParamsModel->getAllParams($userWhere);
