...
use app\common\controller\Site as Sites;
  ...
  public function edit()
  {
    ...
    if (Request::isAjax()) {
      ...
      $siteInfo = [
        ...
        'site_noun'           => !empty($param['site_noun']) ? $param['site_noun'] : 0,
      ];
      ...
      //添加账号的相关信息
      $userNames = isset($param['user Name']) ? $param['userName'] : [];
    ...
    //检测区域选择
    $mall = (new AreaMall())->where('mall_id',$info['mall_id'])->field('shipping_loading_type')->find();
     ...
     * @return array
     */
  public function setCarLoadingType()
  {
      $this->view->engine->layout(false);
