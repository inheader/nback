...
class Goods extends Api
{
    ...
    private $goodsAllowedFields = [
        'id','bn','name','brief','price','price1','price2','price3','price4','price5','price6','image_id','goods_cat_id','goods_type_id','brand_id'
    ...
    private $productAllowedFields = [
        'id','goods_id','barcode','sn','price','price1','price2','price3','price4','price5','price6','marketable','stock','freeze_stock','spes_desc','is_defalut'
    ];
