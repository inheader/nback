        ...
        try{
            ...
            if($resCsv['status']){
                ...
                foreach($iData as $key=>$val){
                    ...
                    $product['price1'] = $val['price1'];
                    $product['price2'] = $val['price2'];
                    $product['price3'] = $val['price3'];
                    $product['price4'] = $val['price4'];
                    $product['price5'] = $val['price5'];
                    $product['price6'] = $val['price6'];
                    ...
                    if($val['is_defalut']&&$val['is_defalut']==$productModel::DEFALUT_YES){
                        ...
                        $goods['price1'] = $val['price1'];
                        $goods['price2'] = $val['price2'];
                        $goods['price3'] = $val['price3'];
                        $goods['price4'] = $val['price4'];
                        $goods['price5'] = $val['price5'];
                        $goods['price6'] = $val['price6'];
                    }
                    Log::record($goods);
